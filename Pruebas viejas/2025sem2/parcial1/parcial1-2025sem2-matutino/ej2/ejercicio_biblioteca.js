...
function buscarLibros(criterios) {
    ...
    for (const libro of biblioteca.libros) {
        if (criterios.id !== undefined && libro.id !== criterios.id) {
            continue;
        }
        if (criterios.titulo !== undefined && libro.titulo !== criterios.titulo) {
            continue;
        }
        if (criterios.autor !== undefined && libro.autor !== criterios.autor) {
            continue;
        }
        if (criterios.categoria !== undefined && libro.categoria !== criterios.categoria) {
            continue;
        }
        if (criterios.añoPublicacion !== undefined && libro.añoPublicacion !== criterios.añoPublicacion) {
            continue;
        }
